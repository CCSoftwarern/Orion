...
class MetricFilter(filters.FilterSet):
    ...
    search_fields =['DATA_VENDA','DT_EMBARQUE','ID_CLIENTES','NM_CLIENTE','ID_OPERADORA', 'NM_OPERADORA','REEMBOLSO','REEMBOLSO']

    class Meta:
        model = models.vendas
        fields = ['DATA_VENDA','DT_EMBARQUE','ID_CLIENTES','NM_CLIENTE','ID_OPERADORA', 'NM_OPERADORA','REEMBOLSO','REEMBOLSO']
