...
class vendas(models.Model):
    ...
    VR_TOTAL = models.DecimalField(max_digits = 5, decimal_places = 2, default=0) 
    VR_TAXAS = models.DecimalField(max_digits = 5, decimal_places = 2, default=0)
    VR_DESCONTO = models.DecimalField(max_digits = 5, decimal_places = 2, default=0)
    VR_ABATIMENTOS = models.DecimalField(max_digits = 5, decimal_places = 2, default=0)
    PORCENTAGEM_COMISSAO = models.DecimalField(max_digits = 5, decimal_places = 2, default=0)
    VR_COMISSAO = models.DecimalField(max_digits = 5, decimal_places = 2, default=0)
    VR_ENTRADA = models.DecimalField(max_digits = 5, decimal_places = 2, default=0)
    VR_PARCELADO = models.DecimalField(max_digits = 5, decimal_places = 2, default=0)
    VR_SALDO = models.DecimalField(max_digits = 5, decimal_places = 2, default=0)
    NR_RESERVA = models.CharField(max_length=30, default="0")
    DT_EMBARQUE = models.DateField(null=False)
    DT_RETORNO = models.DateField(null=False)
    REEMBOLSO = models.BooleanField(default=False)
    COMISSAO_RECEBIDA = models.BooleanField(default=False)
    DT_PGTO_COMISSAO = models.DateField(null=False)
